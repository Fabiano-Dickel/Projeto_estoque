...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="estoque.php">Lacrados</a></li>
    ...
    <div class="direcionamento">
        ...
        <table id="tabela_produtos" >
            ...
            <tbody>
                ...
                $sql = "SELECT p.nome AS nome_produto, c.categoria AS categoria, SUM(r.quantidade) AS quantidade
                FROM produto p
                LEFT JOIN relacionamento r ON p.id_produto = r.id_produto
